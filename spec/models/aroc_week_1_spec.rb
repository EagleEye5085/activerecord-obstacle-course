...
# ----------------------
  ...
  it '2. finds order id of smallest order' do
    ...
    # binding.pry
    order_id = Order.all.order("amount asc").first.id
    # ------------------------------------------------------------
  ...
  it '3. finds order id of largest order' do
    ...
    # Solution goes here
    # Your solution should not contain the ID of the order anywhere
    order_id = order_id = Order.all.order("amount desc").first.id
    # ------------------------------------------------------------
  ...
  it '5. finds multiple items by id' do
    ...
    # Solution goes here
    binding.pry
    items = Item.all.order(:id).find(ids_to_find)
    # ------------------------------------------------------------
  ...
  it '6. finds multiple orders by id' do
    ...
    # Solution goes here
    # binding.pry
    orders = Order.all.order(:id).find(ids_to_find)
    # ------------------------------------------------------------
